...
const AdditionalInformationHome: FunctionComponent = () => (
  <div className="flex flex-col justify-between bg-[#097990] p-[45px] relative max-[1439px]:w-full max-lg:gap-[39px] max-sm:mt-[65px] max-sm:px-[25px] max-sm:pb-[23px] max-sm:pt-[20px]">
