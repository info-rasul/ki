...
const AdditionalInformationServices: FunctionComponent = () => (
    ...
    <span className="text-white	text-[25px] leading-[138%] max-sm:text-[20px] max-sm:leading-[135%]">
        Хотите знать больше? <br className="sm:hidden" /> Читайте новости <br className="max-sm:hidden" /> или подписывайтесь на наш телеграм канал
    </span>
        @@include("../buttons/index.html")
        <img className="absolute top-0 right-[34px] max-sm:hidden" src={oneSvg} alt="Vector" />
    </div>
);
