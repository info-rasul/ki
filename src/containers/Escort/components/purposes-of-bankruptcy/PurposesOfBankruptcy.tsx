...
const PurposesOfBankruptcy = () => {
    return (
        <div>
            ...
            <p className="leading-[170%] text-justify mt-[30px] max-sm:text-[15px] max-sm:leading-[159%] max-sm:mt-[25px]">
            ...
            <div className="pr-[35px] pl-[31px] py-[25px] border-l-4 border-[#BB2525] bg-[#BB2525] bg-opacity-10 mt-[30px] max-sm:mt-[25px] max-sm:py-[20px] max-sm:pr-[30px] max-sm:pl-[26px]">
                <p className="text-[#BB2525] leading-[180%] text-justify max-sm:text-[15px] max-sm:leading-[150%] max-sm:tracking-[-0.1px]">
