                        ...
                        <div className="contacts-banner-img flex justify-between p-[45px] pb-[92px] mt-10 mb-[20px] max-lg:p-[25px] gap-x-5 max-[880px]:flex-col max-md:mb-10">
                            ...
                            <div className="flex flex-col gap-[25px] w-[350px] max-md:w-full max-md:gap-0">
                                <div className="flex flex-col gap-[5px]">
                                    <p style={{ fontSize: 'clamp(15px, 1.8vw, 25px)' }} className="text-white leading-[145%] max-sm:text-[15px] opacity-60">Тел.:</p>
                                    <a style={{ fontSize: 'clamp(18px, 1.8vw, 25px)' }}
                                       className="text-white leading-[145%] max-sm:text-[18px]"
                                ...
                                <div className="flex flex-col gap-[5px]">
                                    ...
                                    <a style={{ fontSize: 'clamp(18px, 1.8vw, 25px)' }}
                                       ...
                                       className="text-white leading-[145%] max-sm:text-[18px]">info@ki112.ru</a>
                                </div>
                            </div>
                        </div>
                    </div>
