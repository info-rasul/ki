...
const BankruptcyConcept = () => {
    return (
        <div>
            <h2 className="text-[30px] leading-[150%] tracking-[.2px] mt-20 mb-10 max-sm:text-[20px] max-sm:leading-[140%] max-sm:mb-[30px]">
                Понятие банкротства
            </h2>
            ...
            <div className="pr-[35px] pl-[31px] py-[25px] border-l-4 border-green-700 bg-teal-200 bg-opacity-10 mt-[27px] max-sm:mt-[24px] max-sm:pr-[30px] max-sm:pl-[26px] max-sm:py-[20px]">
                <p className="text-[#086C80] leading-[180%] tracking-[.13px] max-sm:text-[15px] max-sm:leading-[150%]">
            ...
            <p className="leading-[170%] tracking-[.16px] mt-[30px] max-sm:text-[15px] max-sm:leading-[160%] max-sm:mt-[25px]">
