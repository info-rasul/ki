    ...
    <Fragment>
        <footer className="footer flex flex-col px-20 pt-20 pb-10 bg-custom-gradient max-lg:hidden">
            ...
            <div className="footer__link flex justify-between mt-10 opacity-50">
                <p className="text-white leading-[170%] tracking-[.3px]">@ 2023 Комитет Информации</p>
                <p className="text-white leading-[170%] tracking-[.3px]">Политика конфиденциальности</p>
            </div>
        </footer>
        <footer className="footer lg:hidden flex flex-col items-start bg-custom-gradient max-sm:pt-10 px-4 pb-[25px]">
            <img className="h-[65px] max-sm:h-[40px] w-[155px]" src={oneSvg} alt="logo" />
                ...
                <div className="footer__link flex flex-col gap-[10px] mt-[25px] opacity-50">
                    <p className="text-white leading-[170%] tracking-[.1px] text-[13px]">@ 2023 Комитет Информации</p>
                    <p className="text-white leading-[170%] tracking-[.1px] text-[13px]">Политика конфиденциальности</p>
                </div>
        </footer>
    </Fragment>
);
