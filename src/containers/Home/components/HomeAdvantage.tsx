...
const HomeAdvantage: FunctionComponent = () => (
    <div className="video-back flex flex-col items-center justify-center mt-[120px] max-sm:mt-20 max-sm:px-[25px] max-sm:items-start">
        <video className="max-[850px]:w-[700px] max-[450px]:max-w-[300px]" autoPlay muted loop id="myVideo2">
        ...
        <div className="px-20 py-[50px] max-sm:pt-5 max-sm:pb-[25px] max-sm:px-0">
            ...
            <p className="text-center text-white leading-[170%] mt-[21px] mb-10 tracking-[.7px] max-sm:text-left max-sm:mt-[15px] max-sm:leading-[150%] text-[15px] max-sm:mb-[30px]">
