...
import EscortBanner from '../../../../assets/img/Escort-banner.jpg'
...
const SignsOfBankruptcy = () => {
    return (
        <div>
            ...
            <div className="numbered-list mt-[18px]">
            ...
            <p className="leading-[170%] tracking-[.16px] mt-[32px]">
            ...
            <div className="pr-[35px] pl-[31px] py-[25px] border-l-4 border-green-700 bg-teal-200 bg-opacity-10 mt-[30px]">
                <p className="text-[#086C80] leading-[181%] tracking-[.13px]">
            ...
            <div className="flex flex-col gap-5 mt-[31px]">
                <p className="leading-[170%] tracking-[.16px]">
            ...
            <div className="numbered-list mt-[19px]">
            ...
            <p className="leading-[170%] tracking-[.21px] mt-[31px]">
            ...
            <img className="mt-[79px]" src={EscortBanner} alt="Escort-banner"/>
        </div>
    );
};
