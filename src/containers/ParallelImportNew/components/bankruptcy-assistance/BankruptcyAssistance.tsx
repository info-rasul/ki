...
const BankruptcyAssistance: React.FC<BankruptcyAssistanceProps> = ({ styles }) => {
    return (
        <div>
            <h2 style={{ fontSize: 'clamp(20px, 2.1vw, 30px)' }} className="leading-[45px] max-md:leading-[35px] tracking-[-0.1px] mt-20 mb-10 max-sm:text-[20px] max-sm:mt-[40px] max-sm:mb-[30px] max-sm:tracking-normal">
            ...
            <h2 style={{ fontSize: 'clamp(20px, 2.1vw, 30px)' }} className="leading-[45px] max-md:leading-[35px] tracking-[-0.1px] mt-[47px] mb-[37px] max-sm:text-[20px] max-sm:mt-[40px] max-sm:mb-[30px] max-sm:tracking-normal">
