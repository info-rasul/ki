...
const ArticleBanner = () => {
    return (
        <div className="container article_banner">
            <div className="w-[1440px] px-20 pb-[60px] h-[800px] flex flex-col justify-end max-md:px-4 max-md:h-[645px]">
                <h2 className="text-[40px] leading-[138%] text-white tracking-[.5px] max-md:text-[24px]">
