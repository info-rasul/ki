...
const BankruptcyAssistance: React.FC<BankruptcyAssistanceProps> = ({ styles }) => {
    return (
        <div>
            <h2 style={{ fontSize: 'clamp(20px, 2.1vw, 30px)' }} className="leading-[45px] tracking-[-0.1px] mt-20 mb-10 max-sm:text-[20px] max-sm:mt-[40px] max-sm:mb-[30px] max-sm:tracking-normal">
            ...
            <h2 style={{ fontSize: 'clamp(20px, 2.1vw, 30px)' }} className="leading-[45px] tracking-[-0.1px] mt-[47px] mb-[37px] max-sm:text-[20px] max-sm:mt-[40px] max-sm:mb-[30px] max-sm:tracking-normal">
            ...
            <div className="flex flex-col gap-[27px] mt-[83px]">
                <h2 style={{ fontSize: 'clamp(20px, 2.1vw, 30px)' }} className="leading-[43.5px] mb-[10px] tracking-[-0.1px] max-sm:text-[20px] max-sm:tracking-normal">
